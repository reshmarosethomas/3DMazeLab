...
public class GameManager : MonoBehaviour
{
    ...
    public void ResetRound()
    {
        ...
        if ((gemsCollected >= gemGoal_Lobby && trialNum == 0) || (gemsCollected >= gemGoal_Trial && trialNum > 0))
        {
            ...
            Tinylytics.AnalyticsManager.LogCustomMetric(prolificID + "_TrialNoPet_" +tempTrialName + "_" + tempTrialNum.ToString() + "_" + "TimeTaken", trialTimer.ToString());
            ...
            //2. Log Score
            Tinylytics.AnalyticsManager.LogCustomMetric(SaveProlificID.prolificID + "_TrialNoPet_" + tempTrialName + "_" + tempTrialNum.ToString() + "_" + "GemsCollected", gemsCollected.ToString());

            //3. Heat Map
            heatMapData = string.Join("_", positions);
            Tinylytics.AnalyticsManager.LogCustomMetric(SaveProlificID.prolificID + "_TrialNoPet_" + tempTrialName + "_" + tempTrialNum.ToString() + "_" + "PlayerHeatMap", heatMapData);

            //5. ExitedFullScreen?
            Tinylytics.AnalyticsManager.LogCustomMetric(SaveProlificID.prolificID + "_TrialNoPet_" + tempTrialName + "_" + tempTrialNum.ToString() + "_" + "InFullScreen", inFullScreen.ToString());
